...
app.get('/insert', function (req, res, next) {
  var context = {};
  mysql.pool.query("INSERT INTO exercise (`name`,`reps`,`weight`,`date`,`unit`) VALUES (?,?,?,?,?)", [req.query.name, req.query.reps, req.query.weight, getFormattedDate(req.query.date), req.query.unit], function (err, result) {
    if (err) {
      next(err);
      return;
    }
